...
namespace LynkAdventures.World.Tiles
{
    ...
    /// @version 5.4.2013
    /// <summary>
    /// A rock, that is blended into another tile.
    /// </summary>
    public class TileRockBlend : TileBlended
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="TileRockBlend"/>.
        /// </summary>
        /// <param name="level">The level.</param>
        /// <param name="dir">The blending direction.</param>
        public TileRockBlend(Level level, Direction dir)
            : base(level, dir)
        {
            spriteID = 12;
        }
