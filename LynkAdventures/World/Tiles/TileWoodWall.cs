...
namespace LynkAdventures.World.Tiles
{
    ...
    /// Wooden wall.
    /// </summary>
    public class TileWoodWall : Tile
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="TileWoodWall"/>.
        /// </summary>
        /// <param name="level">The level.</param>
        public TileWoodWall(Level level)
            : base(level)
        {
            spriteID = 10;
        ...
        public override void Render(int xTile, int yTile, Renderer renderer, Level level, byte data = 0)
        {
            ...
            RenderTileDepth(xTile, yTile, 20, GameSpriteSheets.SPRITESHEET_TILES, renderer, level);
        }
    }
}
